...
<%@page import="com.madi.manage.business.entity.Employee"%>
...
<%
	Employee emp = (Employee) SecurityUtils.getSubject().getSession().getAttribute("user");
	if(emp == null){%>
	<script>location.href = "../../403";</script>
	<%}
 %>
<script>
//登录系统时的操作方法
function documentHasReady(){
	console.log("asd");
	handlePageLimit();
	var user = "<%=emp.getUsername()%>";
	var pass = "madisoftadmin";
	if (user == '' || pass == '') {
		alert("请输入用户名和密码");
		return;
	}
...
<script>
	function loginCallback(){
		createMomogrouplistUL("<%=request.getParameter("id")%>","");
		$("#<%=request.getParameter("id")%>").click();
	}
</script>
</head>
<body>
    ...
    <div class="content" id="content" style="display: none">
        <div class="leftcontact" id="leftcontact" style="display:none!important;">
        ...
        <div class="chatRight">
            ...
            <div class="chat02">
                <div class="chat02_title">
					...
					<a id='sendPicBtn' class="chat02_title_btn ctb03" title="选择图片" type='img' href="#"></a>
					<input id='sendAudioInput' style='display:none'/>
					<a id='sendAudioBtn' class="chat02_title_btn ctb02" title="选择语音" href="#" type='audio'></a>
					<input id='sendFileInput' class='emim-hide'/>
					<a id='sendFileBtn' class="chat02_title_btn ctb04" title="选择文件" href="#"></a>
